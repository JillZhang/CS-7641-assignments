...
class PenDigitData(DataLoader):
    ...
    def pre_training_adjustment(self, train_features, train_classes):
        return train_features, train_classes
class Rain(DataLoader):
    def __init__(self, path='data/data_rain.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
...
class Shelter(DataLoader):
    def __init__(self, path='data/data.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
